...
class DrfSchemaService {
	...
	private const FARM_OPERATION_IDS = [
		...
		'rvi_latest' => 'v1_farms_rvi_latest_retrieve',
		'rvi_timeseries' => 'v1_farms_rvi_timeseries_retrieve',
		'rvi_raster' => 'v1_farms_rvi_raster.png_retrieve',
		'rvi_raster_queue' => 'v1_farms_rvi_raster_queue_create',
		'rvi_refresh' => 'v1_farms_rvi_refresh_create',
		'rvi_farm_state' => 'v1_farms_rvi_farm_state_retrieve',
		's1_smi_latest' => 'v1_farms_s1_smi_latest_retrieve',
		's1_smi_timeseries' => 'v1_farms_s1_smi_timeseries_retrieve',
		's1_smi_raster' => 'v1_farms_s1_smi_raster.png_retrieve',
		's1_smi_raster_queue' => 'v1_farms_s1_smi_raster_queue_create',
		's1_smi_refresh' => 'v1_farms_s1_smi_refresh_create',
		's1_smi_farm_state' => 'v1_farms_s1_smi_farm_state_retrieve',
		's3_lst_latest' => 'v1_farms_s3_lst_latest_retrieve',
		's3_lst_timeseries' => 'v1_farms_s3_lst_timeseries_retrieve',
		's3_lst_raster' => 'v1_farms_s3_lst_raster.png_retrieve',
		's3_lst_raster_queue' => 'v1_farms_s3_lst_raster_queue_create',
		's3_lst_refresh' => 'v1_farms_s3_lst_refresh_create',
		's3_lst_farm_state' => 'v1_farms_s3_lst_farm_state_retrieve',
		'landsat_lst_latest' => 'v1_farms_landsat_lst_latest_retrieve',
		'landsat_lst_timeseries' => 'v1_farms_landsat_lst_timeseries_retrieve',
		'landsat_lst_raster' => 'v1_farms_landsat_lst_raster.png_retrieve',
		'landsat_lst_raster_queue' => 'v1_farms_landsat_lst_raster_queue_create',
		'landsat_lst_refresh' => 'v1_farms_landsat_lst_refresh_create',
		'landsat_lst_farm_state' => 'v1_farms_landsat_lst_farm_state_retrieve',
		'iron_oxide_latest' => 'v1_farms_iron_oxide_latest_retrieve',
		'iron_oxide_timeseries' => 'v1_farms_iron_oxide_timeseries_retrieve',
		'iron_oxide_raster' => 'v1_farms_iron_oxide_raster.png_retrieve',
		'iron_oxide_raster_queue' => 'v1_farms_iron_oxide_raster_queue_create',
		'iron_oxide_refresh' => 'v1_farms_iron_oxide_refresh_create',
		'iron_oxide_farm_state' => 'v1_farms_iron_oxide_farm_state_retrieve',
		'evi_latest' => 'v1_farms_evi_latest_retrieve',
		'evi_timeseries' => 'v1_farms_evi_timeseries_retrieve',
		'evi_raster' => 'v1_farms_evi_raster.png_retrieve',
		'evi_raster_queue' => 'v1_farms_evi_raster_queue_create',
		'evi_refresh' => 'v1_farms_evi_refresh_create',
		'evi_farm_state' => 'v1_farms_evi_farm_state_retrieve',

		'l_rvi_latest' => 'v1_farms_l_rvi_latest_retrieve',
		'l_rvi_timeseries' => 'v1_farms_l_rvi_timeseries_retrieve',
		'l_rvi_raster' => 'v1_farms_l_rvi_raster.png_retrieve',
		'l_rvi_raster_queue' => 'v1_farms_l_rvi_raster_queue_create',
		'l_rvi_refresh' => 'v1_farms_l_rvi_refresh_create',
		'l_rvi_farm_state' => 'v1_farms_l_rvi_farm_state_retrieve',
		'nisar_smi_latest' => 'v1_farms_nisar_smi_latest_retrieve',
		'nisar_smi_timeseries' => 'v1_farms_nisar_smi_timeseries_retrieve',
		'nisar_smi_raster' => 'v1_farms_nisar_smi_raster.png_retrieve',
