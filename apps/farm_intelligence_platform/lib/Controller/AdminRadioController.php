...
final class AdminRadioController extends Controller {
	private const OPERATION_IDS = [
		...
		'stations_stream_retrieve' => 'v1_radio_stations_stream_retrieve',
		'stations_now_playing_retrieve' => 'v1_radio_stations_now_playing_retrieve',
		'stations_analytics_retrieve' => 'v1_radio_stations_analytics_retrieve',
		'stations_health_list' => 'v1_radio_stations_health_list',
		'radio_health_retrieve' => 'v1_radio_health_retrieve',
		'emergency_current_retrieve' => 'v1_radio_emergency_current_retrieve',
		'emergency_history_list' => 'v1_radio_emergency_history_list',
		'emergency_create' => 'v1_radio_emergency_create',
		'emergency_update' => 'v1_radio_emergency_partial_update',
		'emergency_destroy' => 'v1_radio_emergency_destroy',
		'tts_create' => 'v1_radio_tts_create',
	];
