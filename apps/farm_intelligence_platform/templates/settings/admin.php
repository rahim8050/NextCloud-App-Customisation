		...
		<div class="form-group farm-intelligence-platform-farms" id="farm-intelligence-platform-farms">
			...
			<div class="farm-intelligence-platform-farms__panels">
				<div class="farm-intelligence-platform-farms__ndvi" id="farm-intelligence-platform-farms-ndvi" hidden>
					...
					<div class="farm-intelligence-platform-farms__ndvi-actions">
						<button id="farm-intelligence-platform-ndre-latest" type="button" class="button"><?php p($l->t('Latest NDRE')); ?></button>
						<button id="farm-intelligence-platform-ndre-timeseries" type="button" class="button"><?php p($l->t('NDRE Timeseries')); ?></button>
						<button id="farm-intelligence-platform-ndre-queue" type="button" class="button"><?php p($l->t('Queue NDRE raster')); ?></button>
						<button id="farm-intelligence-platform-ndre-refresh" type="button" class="button"><?php p($l->t('Refresh NDRE')); ?></button>
						<button id="farm-intelligence-platform-ndre-raster" type="button" class="button"><?php p($l->t('NDRE Raster PNG')); ?></button>
						<button id="farm-intelligence-platform-ndre-state" type="button" class="button"><?php p($l->t('NDRE State')); ?></button>
					</div>
					<div class="farm-intelligence-platform-farms__ndvi-actions">
						<button id="farm-intelligence-platform-biomass-latest" type="button" class="button"><?php p($l->t('Latest Biomass')); ?></button>
						<button id="farm-intelligence-platform-biomass-timeseries" type="button" class="button"><?php p($l->t('Biomass Timeseries')); ?></button>
						<button id="farm-intelligence-platform-biomass-queue" type="button" class="button"><?php p($l->t('Queue Biomass raster')); ?></button>
						<button id="farm-intelligence-platform-biomass-refresh" type="button" class="button"><?php p($l->t('Refresh Biomass')); ?></button>
						<button id="farm-intelligence-platform-biomass-raster" type="button" class="button"><?php p($l->t('Biomass Raster PNG')); ?></button>
						<button id="farm-intelligence-platform-biomass-state" type="button" class="button"><?php p($l->t('Biomass State')); ?></button>
					</div>
					<!-- In-Situ Section -->
					<div class="farm-intelligence-platform-farms__section-header">
						<strong><?php p($l->t('In-Situ Data')); ?></strong>
					</div>
					<div class="farm-intelligence-platform-farms__ndvi-actions">
						<button id="farm-intelligence-platform-insitu-validation" type="button" class="button"><?php p($l->t('Validation Report')); ?></button>
					</div>
					<div class="farm-intelligence-platform-farms__section-header">
						<strong><?php p($l->t('Soil Moisture Samples')); ?></strong>
					</div>
					<div class="farm-intelligence-platform-farms__ndvi-actions">
						<button id="farm-intelligence-platform-insitu-moisture-list" type="button" class="button"><?php p($l->t('List Samples')); ?></button>
						<button id="farm-intelligence-platform-insitu-moisture-create" type="button" class="button"><?php p($l->t('Add Sample')); ?></button>
					</div>
					<div class="farm-intelligence-platform-farms__section-header">
						<strong><?php p($l->t('Harvest Records')); ?></strong>
					</div>
					<div class="farm-intelligence-platform-farms__ndvi-actions">
						<button id="farm-intelligence-platform-insitu-harvest-list" type="button" class="button"><?php p($l->t('List Harvests')); ?></button>
						<button id="farm-intelligence-platform-insitu-harvest-create" type="button" class="button"><?php p($l->t('Add Harvest')); ?></button>
					</div>
					<div class="farm-intelligence-platform-farms__section-header">
						<strong><?php p($l->t('Biomass Observations')); ?></strong>
					</div>
					<div class="farm-intelligence-platform-farms__ndvi-actions">
						<button id="farm-intelligence-platform-insitu-biomass-list" type="button" class="button"><?php p($l->t('List Observations')); ?></button>
						<button id="farm-intelligence-platform-insitu-biomass-create" type="button" class="button"><?php p($l->t('Add Observation')); ?></button>
					</div>
					<div class="farm-intelligence-platform-farms__section-header">
						<strong><?php p($l->t('Tree Surveys')); ?></strong>
					</div>
					<div class="farm-intelligence-platform-farms__ndvi-actions">
						<button id="farm-intelligence-platform-insitu-tree-list" type="button" class="button"><?php p($l->t('List Surveys')); ?></button>
						<button id="farm-intelligence-platform-insitu-tree-create" type="button" class="button"><?php p($l->t('Add Survey')); ?></button>
					</div>
					<div id="farm-intelligence-platform-insitu-output" class="farm-intelligence-platform-farms__ndvi-output"></div>
					<div id="farm-intelligence-platform-insitu-error" class="farm-intelligence-platform-farms__note error farm-intelligence-platform-farms__ndvi-error" hidden></div>
