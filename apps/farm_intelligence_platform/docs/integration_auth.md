...
- Nextcloud app config (Settings → Administration → Farm Intelligence Platform):
...
```bash
occ config:app:delete farm_intelligence_platform clientId
occ config:app:delete farm_intelligence_platform hmacSecret
occ config:app:delete farm_intelligence_platform hmacSecretPrevious
occ config:app:delete farm_intelligence_platform hmacSecretPreviousExpiresAt
occ config:app:delete farm_intelligence_platform hmac_client_id
occ config:app:delete farm_intelligence_platform hmac_secret
occ config:app:delete farm_intelligence_platform signingSecret
occ config:app:delete farm_intelligence_platform base_url
occ config:app:delete farm_intelligence_platform api_key
occ config:app:delete farm_intelligence_platform timeout_seconds
occ config:app:delete farm_intelligence_platform dev_allow_insecure_local_http
occ config:app:delete farm_intelligence_platform dev_allowlist_hosts
occ config:app:delete farm_intelligence_platform devAllowlistHosts
```
