...
|---|---|---|
| GET | `/apps/farm_intelligence_platform/api/v1/admin/farms/schema` | `adminFarms#getSchema` |
| POST | `/apps/farm_intelligence_platform/api/v1/admin/farms/list` | `adminFarms#listFarms` |
| POST | `/apps/farm_intelligence_platform/api/v1/admin/farms/create` | `adminFarms#createFarm` |
| GET | `/apps/farm_intelligence_platform/api/v1/admin/farms/{id}` | `adminFarms#getFarm` |
| PUT | `/apps/farm_intelligence_platform/api/v1/admin/farms/{id}` | `adminFarms#updateFarm` |
| PATCH | `/apps/farm_intelligence_platform/api/v1/admin/farms/{id}` | `adminFarms#patchFarm` |
| DELETE | `/apps/farm_intelligence_platform/api/v1/admin/farms/{id}` | `adminFarms#deleteFarm` |
| GET | `/apps/farm_intelligence_platform/api/v1/admin/farms/{farmId}/ndvi/latest` | `adminFarms#getNdviLatest` |
| GET | `/apps/farm_intelligence_platform/api/v1/admin/farms/{farmId}/ndvi/timeseries` | `adminFarms#getNdviTimeseries` |
| POST | `/apps/farm_intelligence_platform/api/v1/admin/farms/{farmId}/ndvi/refresh` | `adminFarms#refreshNdvi` |
| POST | `/apps/farm_intelligence_platform/api/v1/admin/farms/{farmId}/ndvi/raster/queue` | `adminFarms#queueNdviRaster` |
| GET | `/apps/farm_intelligence_platform/api/v1/admin/farms/{farmId}/ndvi/raster.png` | `adminFarms#getNdviRasterPng` |
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -b "<COOKIE_REDACTED>"   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/schema"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -H "Content-Type: application/json"   -b "<COOKIE_REDACTED>"   -d '{}'   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/list"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -H "Content-Type: application/json"   -b "<COOKIE_REDACTED>"   -d '{"name":"Golden Farm A","is_active":true}'   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/create"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -H "Content-Type: application/json"   -b "<COOKIE_REDACTED>"   -X PATCH -d '{"name":"Golden Farm A Updated"}'   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/<FARM_ID>"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -b "<COOKIE_REDACTED>"   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/<FARM_ID>"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -b "<COOKIE_REDACTED>"   -X DELETE   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/<FARM_ID>"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -b "<COOKIE_REDACTED>"   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/<FARM_ID>/ndvi/latest?lookback_days=14&max_cloud=30"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -b "<COOKIE_REDACTED>"   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/<FARM_ID>/ndvi/timeseries?start=2026-01-20&end=2026-01-27&max_cloud=30"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -b "<COOKIE_REDACTED>"   -X POST   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/<FARM_ID>/ndvi/refresh"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -H "Content-Type: application/json"   -b "<COOKIE_REDACTED>"   -X POST -d '{"date":"2026-01-20"}'   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/<FARM_ID>/ndvi/raster/queue"
```
...
```bash
curl -k -sS -D -   -H "OCS-APIRequest: true"   -H "requesttoken: <REQUEST_TOKEN>"   -b "<COOKIE_REDACTED>"   "https://127.0.0.1/nextcloud/index.php/apps/farm_intelligence_platform/api/v1/admin/farms/<FARM_ID>/ndvi/raster.png?date=2026-01-20"   -o /tmp/ndvi-raster.png
```
...
```
Weather API admin endpoint hit {"action":"list farms","requestId":"<REQ_ID>","method":"POST","path":"/apps/farm_intelligence_platform/api/v1/admin/farms/list"}
