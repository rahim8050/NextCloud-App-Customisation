...
Manual (end-to-end)
1) Configure Nextcloud Farm Intelligence Platform settings with `baseUrl`, `INTEGRATION_HMAC_CLIENT_ID`, `INTEGRATION_HMAC_CLIENTS_JSON`, `apiKey`, and `timeoutSeconds`.
