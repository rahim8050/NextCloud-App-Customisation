...
### In scope
- Files under `apps/farm_intelligence_platform/` only.
...
- PHP lint, style check, static analysis, and unit tests via composer scripts documented in `apps/farm_intelligence_platform/CONTRIBUTING.md`.
